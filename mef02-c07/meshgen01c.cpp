...
#include "meshgen01c.h"

/* --------------------------------------------------------------------------- */

void meshgen01c (cmalla2d01 *m, cnodo2d a, cnodo2d b, 
    ...
    */
    ...
    newnode = new cnodo2d (13, 0.5*(p.x+q.x), p.y, 1.0);
    gnodos[13] = newnode;
    m->nodos[13] = newnode;
    ...
    newside = new carista (12, m->nodos[4], m->nodos[13]);
    garistas[12] = newside;
    ...
    newside = new carista (28, m->nodos[5], m->nodos[13]);
    garistas[28] = newside;
    m->aristas[28] = newside;

    newside = new carista (29, m->nodos[12], m->nodos[13]);
    garistas[29] = newside;
    m->aristas[29] = newside;

    newside = new carista (30, m->nodos[8], m->nodos[13]);
    garistas[30] = newside;
    m->aristas[30] = newside;
    ...
    newelt = new celem2d (1, m->nodos[13], m->nodos[4], m->nodos[8], m->aristas[14], m->aristas[30], m->aristas[12]);
    geltos[1] = newelt;
    m->eltos[1] = newelt;
    ...
    newelt = new celem2d (15, m->nodos[13], m->nodos[12], m->nodos[4], m->aristas[26], m->aristas[12], m->aristas[29]);
    geltos[15] = newelt;
    m->eltos[15] = newelt;

    newelt = new celem2d (16, m->nodos[13], m->nodos[5], m->nodos[12], m->aristas[27], m->aristas[29], m->aristas[28]);
    geltos[16] = newelt;
    m->eltos[16] = newelt;

    newelt = new celem2d (17, m->nodos[13], m->nodos[8], m->nodos[5], m->aristas[15], m->aristas[28], m->aristas[30]);
    geltos[17] = newelt;
    m->eltos[17] = newelt;
