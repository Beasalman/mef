...
void reft110 (cmalla2d01 *m, map <int, celem2d *> &geltos, map <int, carista *> &garistas,
              int i, int j, int k) {

    /* Refinamiento de un triángulo en tres subtriángulos (caso 110).
    ...
    */
    ...
    cnodo2d *n0, *n1, *n2, *m0, *m1;
    celem2d *ef;
    celem2d *newelt;
    carista *a0, *a1, *a2, *q0, *q1, *r1, *r2, *r3, *r4;
