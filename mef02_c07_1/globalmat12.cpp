#include "globalmat12.h"

/* -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*- */

void globalmat12 (cmalla2d01 *m, cgauss02 *g, double deltat, double f, cdiffusion2d *diff, SparseMatrix<double> &a) {

    /* MATVEC12: Operador de Black-Scholes. Matriz del sistema de ecuaciones.
                 Matrices huecas.
...
//        aelt = (1.0 - deltatau * f) * aelt02 + deltatau * aelt01;
        aelt = aelt02 + deltatau * aelt01;
//        aelt = aelt01;
